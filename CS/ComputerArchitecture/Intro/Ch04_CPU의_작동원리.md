...
프로그램을 이루는 수많은 명령어는 일반적으로 인출과 실행 사이클을 반복하며 실행된다. 하지만 일부 명령어는 위 경우에 해당하지 않기도 한다. 간접 주소 지정 방식과 같이 _명령어를 실행하기 위해서는 메모리 접근을 한 번 더 해야 하기 때문_이다. 이 단계를 `간접 사이클(indirect cycle)`이라고 한다.
...
![](https://velog.velcdn.com/images/ncookie/post/f0b97d09-4941-4a50-9659-7f341d610649/image.png)
